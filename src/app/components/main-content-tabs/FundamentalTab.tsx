...
const FundamentalTab: React.FC<FundamentalTabProps> = ({ instrument }) => {
  ...
  const getRatingColor = (rating: string) => {
    switch (rating) {
      case 'Strong Buy': return 'text-[#50ff7a]';
      case 'Buy': return 'text-[#4db04d]';
  ...
  if (!fundamental) {
    return (
      <div className="bg-[var(--bg-card-primary)] rounded-lg p-6 text-center">
        <p className="text-[var(--text-secondary)]">Fundamental data not available for {instrument.name}</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--bg-card-primary)] rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-[var(--text-secondary)]">Net Margin</span>
        ...
        <div className="bg-[var(--bg-card-primary)] rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">Quick Ratio</span>
              <span className="font-medium">{fundamental.quickRatio}</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">Interest Coverage</span>
              <span className="font-medium">8.2x</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[var(--text-secondary)]">Cash Flow (OCF)</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--bg-card-primary)] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">Revenue Growth (YoY)</span>
              <span className="font-medium text-[var(--positive)]">+{fundamental.revenueGrowth}%</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">EPS Growth (YoY)</span>
              <span className="font-medium text-[var(--positive)]">+{fundamental.earningsGrowth}%</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">EBITDA Growth</span>
              <span className="font-medium text-[var(--positive)]">+18.3%</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[var(--text-secondary)]">FCF Growth</span>
              <span className="font-medium text-[var(--positive)]">+22.7%</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[var(--bg-card-primary)] rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center pb-2 border-b border-[var(--border)]">
              <span className="text-[var(--text-secondary)]">Dividend Growth</span>
              <span className="font-medium text-[var(--positive)]">+12.5%</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[var(--text-secondary)]">Next Ex-Date</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <span className="text-[var(--text-secondary)] text-sm">Consensus Rating</span>
                <div className={`text-xl font-semibold mt-1 ${getRatingColor(fundamental.analystRating)}`}>
                  {fundamental.analystRating}
                </div>
              </div>
              <div className="text-right">
                <span className="text-[var(--text-secondary)] text-sm">Analysts</span>
                <div className="text-xl font-semibold mt-1">{fundamental.analystCount}</div>
              </div>
            </div>
            
            <div className="bg-[var(--bg-card-secondary)] rounded-lg p-4 mb-4">
              <div className="flex justify-between items-center mb-2">
                <span className="text-[var(--text-secondary)]">Target Price</span>
          ...
          <div className="bg-[var(--bg-card-secondary)] rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <div className="w-20 text-[var(--text-secondary)] text-sm">Strong Buy</div>
              ...
              <div className="flex items-center">
                <div className="w-20 text-[var(--text-secondary)] text-sm">Buy</div>
                <div className="flex-1 bg-zinc-700 rounded h-2.5">
                  <div 
                    className="bg-[var(--positive)] h-2.5 rounded" 
                    style={{ width: '22%' }}
                  ></div>
                </div>
              ...
              <div className="flex items-center">
                <div className="w-20 text-[var(--text-secondary)] text-sm">Hold</div>
                <div className="flex-1 bg-zinc-700 rounded h-2.5">
                  <div 
              ...
              <div className="flex items-center">
                <div className="w-20 text-[var(--text-secondary)] text-sm">Sell</div>
                <div className="flex-1 bg-zinc-700 rounded h-2.5">
                  <div 
              ...
              <div className="flex items-center">
                <div className="w-20 text-[var(--text-secondary)] text-sm">Strong Sell</div>
                <div className="flex-1 bg-zinc-700 rounded h-2.5">
                  <div 
      ...
      <div className="bg-[var(--bg-card-primary)] rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-4 text-[var(--text-primary)] flex items-center">
          <BookOpen className="w-5 h-5 mr-2 text-[var(--accent-main)]" />
          ...
          <table className="w-full text-sm text-left text-[var(--text-secondary)]">
            ...
            <tbody>
              <tr className="border-b border-[var(--border)]">
                <td className="px-4 py-3 font-medium text-primary">Revenue</td>
                <td className="px-4 py-3">{fundamental.revenue}</td>
                <td className="px-4 py-3 text-[var(--positive)]">+{fundamental.revenueGrowth}%</td>
                <td className="px-4 py-3">₹6,54,320 Cr</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-4 py-3 font-medium text-primary">Net Income</td>
                <td className="px-4 py-3">{fundamental.earnings}</td>
                <td className="px-4 py-3 text-[var(--positive)]">+{fundamental.earningsGrowth}%</td>
                <td className="px-4 py-3">₹38,450 Cr</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-4 py-3 font-medium text-primary">Operating Cash Flow</td>
                <td className="px-4 py-3">₹72,850 Cr</td>
                <td className="px-4 py-3 text-[var(--positive)]">+18.3%</td>
                <td className="px-4 py-3">₹58,230 Cr</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-4 py-3 font-medium text-primary">Total Assets</td>
                <td className="px-4 py-3">₹12,45,600 Cr</td>
                <td className="px-4 py-3 text-[var(--positive)]">+15.7%</td>
                <td className="px-4 py-3">₹9,87,450 Cr</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-primary">Total Debt</td>
