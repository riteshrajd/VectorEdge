...
const SidebarLeft: React.FC<SidebarLeftProps> = ({ onItemSelect }) => {
  ...
  return (
    <aside
      ...
      } h-full bg-[var(--bg-primary)] text-[var(--text-primary)] transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] border-r border-[var(--border)] flex flex-col overflow-clip`}
    >
      {/* Header with toggle */}
